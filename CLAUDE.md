...
| P1 | PreCompact hook で state.json / Memory を自動退避 (§12) |
...
- claudeos/system/role-contracts.md
...
- Extended thinking (`thinking: {type: "enabled", budget_tokens: N}`) を API 経由で指定（400 エラー）
- temperature / top_p / top_k の指定（400 エラー）
